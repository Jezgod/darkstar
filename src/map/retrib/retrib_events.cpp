...
{
    {Retrib::Stat::STAT_BATTLEFIELD, Retrib::Stat::STAT_PVP},
...
{
    {"Win BCNMs and Battlefield Events", "Gain PVP Victories"},
...
{
    Index = dsprand::GetRandomNumber(0, (uint8)Tasks[SERVER_DAY].size() + 0);
...
auto CStrongest::SetRewards(uint8 Type) -> void
{
    ...
    {
        // SET WEEKLY ITEMS
        uint8 Tier = (uint8)dsprand::GetRandomNumber(1, 100);
