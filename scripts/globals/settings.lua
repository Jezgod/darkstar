...
COFFER_MAX_ILLUSION_TIME = 10;  -- 10 seconds
COFFER_MIN_ILLUSION_TIME = 5;  -- 5 seconds
CHEST_MAX_ILLUSION_TIME  = 10;  -- 10 seconds
CHEST_MIN_ILLUSION_TIME  = 5;  -- 5 seconds
...
OldSchoolG1 = false; -- Set to true to require farming Exoray Mold, Bomb Coal, and Ancient Papyrus drops instead of allowing key item method.
