...
function onTrigger(player,npc)
    local stock =
    {
        ...
        --4930, 1192500,    -- Scroll of Katon: San
        --4933, 1192500,    -- Scroll of Hyoton: San
        --4936, 1192500,    -- Scroll of Huton: San
        --4939, 1192500,    -- Scroll of Doton: San
        --4942, 1192500,    -- Scroll of Raiton: San
        --4945, 1192500,    -- Scroll of Suiton: San
    }
