...
local job_map =
{
	[dsp.job.MNK]	=	{relic = {final = 18264, name = "SPHARAI",       base = 18260, ore1 = 1261, ore2 = 1255, qty1 = 12, qty2 = 12}},
	[dsp.job.RDM]	=	{relic = {final = 18276, name = "EXCALIBUR",     base = 18272, ore1 = 1261, ore2 = 1255, qty1 = 12, qty2 = 12}},
	[dsp.job.PLD]	=	{relic = {final = 18276, name = "EXCALIBUR",     base = 18272, ore1 = 1261, ore2 = 1255, qty1 = 12, qty2 = 12}},
	[dsp.job.WAR]	=	{relic = {final = 18294, name = "BRAVURA",       base = 18290, ore1 = 1261, ore2 = 1255, qty1 = 12, qty2 = 12}},
        [dsp.job.DRK]	=	{relic = {final = 18306, name = "APOCALYPSE",     base = 18302, ore1 = 1261, ore2 = 1255, qty1 = 12, qty2 = 12}},
        [dsp.job.NIN]	=	{relic = {final = 18312, name = "KIKOKU",        base = 18308, ore1 = 1259, ore2 = 1257, qty1 = 12, qty2 = 12}},
	[dsp.job.WHM]	=	{relic = {final = 18324, name = "MJOLLNIR",      base = 18320, ore1 = 1259, ore2 = 1257, qty1 = 12, qty2 = 12}},
	[dsp.job.RNG]	=	{relic = {final = 18348, name = "YOICHINOYUMI",  base = 18344, ore1 = 1260, ore2 = 1256, qty1 = 12, qty2 = 12}},
	[dsp.job.SAM]	=	{relic = {final = 18348, name = "YOICHINOYUMI",  base = 18344, ore1 = 1260, ore2 = 1256, qty1 = 12, qty2 = 12}},
	[dsp.job.BRD]	=	{relic = {final = 18342, name = "GJALLAHORN",    base = 18338, ore1 = 1262, ore2 = 1261, qty1 = 12, qty2 = 12}}
}
